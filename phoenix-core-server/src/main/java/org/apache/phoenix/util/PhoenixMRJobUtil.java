...
public class PhoenixMRJobUtil {
  ...
  public static String getActiveResourceManagerAddress(Configuration config, String zkQuorum)
    throws IOException, InterruptedException, KeeperException, InvalidProtocolBufferException,
  ...
  public static String getJobsInformationFromRM(String rmAddress, Map<String, String> urlParams)
    ...
    try {
      ...
      urlBuilder.append(RM_HTTP_SCHEME + "://").append(rmAddress).append(RM_APPS_GET_ENDPOINT);
