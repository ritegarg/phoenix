...
public class ClusterRoleRecord {
    ...
    public enum ClusterRole {
        ...
        static {
            // Initialize allowed transitions (just the target roles)
            ACTIVE_NOT_IN_SYNC.allowedTransitions = ImmutableSet.of(
                    ACTIVE_NOT_IN_SYNC, ACTIVE, ACTIVE_NOT_IN_SYNC_TO_STANDBY
            );
            ...
            // Initialize empty transitions for other roles (can be expanded later)
         ...
         * @return wait time in milliseconds, or null if transition is not allowed
         */
