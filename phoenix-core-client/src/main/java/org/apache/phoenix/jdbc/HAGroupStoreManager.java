...
public interface HAGroupStoreManager {
     ...
     */
    boolean isMutationBlocked() throws IOException;
     ...
     * @throws IOException when HAGroupStoreClient is not healthy.
     */
    boolean isMutationBlocked(String haGroupName) throws IOException;
     ...
     * @throws Exception
     */
    void invalidateHAGroupStoreClient() throws Exception;
     ...
     * @throws Exception
     */
    void invalidateHAGroupStoreClient(String haGroupName) throws Exception;
     ...
     * @throws IOException when HAGroupStoreClient is not healthy.
     */
    Optional<HAGroupStoreRecord> getHAGroupStoreRecord(String haGroupName) throws IOException;
     ...
     * @throws IOException when HAGroupStoreClient is not healthy.
     */
    void setHAGroupStatusToStoreAndForward(String haGroupName) throws IOException, StaleHAGroupStoreRecordVersionException, InvalidClusterRoleTransitionException;
     ...
     * @throws IOException when HAGroupStoreClient is not healthy.
     */
    void setHAGroupStatusRecordToSync(String haGroupName) throws IOException, StaleHAGroupStoreRecordVersionException, InvalidClusterRoleTransitionException;
