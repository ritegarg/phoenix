...
/**
 * Callable implementation for coprocessor endpoint associated with SYSTEM.CHILD_LINK
 */
class ChildLinkMetaDataServiceCallBack
  ...
  public ChildLinkMetaDataServiceCallBack(RpcController controller,
  ...
  public MetaDataResponse call(ChildLinkMetaDataService instance) throws IOException {
    ...
    CreateViewAddChildLinkRequest.Builder builder = CreateViewAddChildLinkRequest.newBuilder();
