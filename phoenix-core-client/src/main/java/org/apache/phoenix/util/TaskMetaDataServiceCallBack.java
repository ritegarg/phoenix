...
/**
 * Callable implementation for coprocessor endpoint associated with SYSTEM.TASK
 */
public class TaskMetaDataServiceCallBack
  ...
  @Override
  public MetaDataResponse call(TaskMetaDataService instance) throws IOException {
