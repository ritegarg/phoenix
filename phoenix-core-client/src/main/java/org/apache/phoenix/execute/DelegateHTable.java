...
public class DelegateHTable extends CompatDelegateHTable implements Table {
  ...
  public <R extends Message> Map<byte[], R> batchCoprocessorService(
    ...
    return delegate.batchCoprocessorService(methodDescriptor, request, startKey, endKey,
      responsePrototype);
  }
  ...
  public <R extends Message> void batchCoprocessorService(MethodDescriptor methodDescriptor,
    ...
    delegate.batchCoprocessorService(methodDescriptor, request, startKey, endKey,
      responsePrototype);
  }
