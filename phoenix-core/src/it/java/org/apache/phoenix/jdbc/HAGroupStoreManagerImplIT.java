...
public class HAGroupStoreManagerImplIT extends BaseTest {
    ...
    public static synchronized void doSetup() throws Exception {
        ...
        props.put(HAGroupStoreManagerFactory.HA_GROUP_STORE_MANAGER_IMPL_CLASS_KEY, "HAGroupStoreManagerImpl");
    ...
    public void testMutationBlockingWithSingleHAGroup() throws Exception {
        ...
        assertTrue(haGroupStoreManager.isMutationBlocked());
    ...
    public void testMutationBlockingWithMultipleHAGroups() throws Exception {
        ...
        // Create two HA groups with ACTIVE roles
        ...
        HAGroupStoreRecord activeRecord2 = new HAGroupStoreRecord(
                "1.0", haGroupName2, ClusterRoleRecord.ClusterRole.ACTIVE,
        ...
        // Update only second group to ACTIVE_TO_STANDBY
        HAGroupStoreRecord transitionRecord2 = new HAGroupStoreRecord(
                "1.0", haGroupName2, ClusterRoleRecord.ClusterRole.ACTIVE_TO_STANDBY,
    ...
    public void testMutationBlockDisabled() throws Exception {
        ...
        conf.set(HAGroupStoreManagerFactory.HA_GROUP_STORE_MANAGER_IMPL_CLASS_KEY, "HAGroupStoreManagerImpl");
    ...
    public void testSetHAGroupStatusMethodsWithNonExistentGroup() throws Exception {
        ...
        try {
            haGroupStoreManager.setHAGroupStatusToStoreAndForward(nonExistentGroupName);
        ...
        try {
            haGroupStoreManager.setHAGroupStatusRecordToSync(nonExistentGroupName);
            fail("Expected IOException to be thrown");
        } catch (IOException e) {
            assertEquals("HAGroupStoreRecord not found in system table for HA group " + nonExistentGroupName, e.getMessage());
        }
